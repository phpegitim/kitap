		...
		<div class="panel-body">
			<form id="profile">
				...
				<div class="form-group">
					...
					<input type="user_name" class="form-control" disabled="disabled" value="<?=$user->getUserName()?>" placeholder="E-Mail adresinizi giriniz">
				...
				<div class="form-group">
					...
					<input type="text" name="first_name" class="form-control" value="<?=$user->getFirstName()?>" placeholder="İsiminizi giriniz">
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">Soyisim</label>
					<input type="text" name="last_name" class="form-control" value="<?=$user->getLastName()?>" placeholder="Soyisminizi giriniz">
				</div>				
